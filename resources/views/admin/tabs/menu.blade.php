                ...
                <tr class="hover:bg-blue-50/30 transition group">
                    ...
                    <td class="px-6 py-3 text-center">
                        <div class="flex justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
                            <button @click="editModalOpen = true; editUrl = '{{ route('admin.menu.update', $item->id) }}'; editData = { name: '{{ addslashes($item->name) }}', category: '{{ $item->category }}', price: '{{ $item->price }}', stock: '{{ $item->stock }}', description: '{{ addslashes($item->description) }}' }" class="p-2 text-blue-600 hover:bg-blue-100 rounded-lg"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg></button>
